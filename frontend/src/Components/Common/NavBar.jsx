...
const NavBar = () => {
  ...
  useEffect(() => {
    const fetchLiveCount = async () => {
      try {
        const response = await axios.get(DOMAIN + "/user/live-auction-count", {
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-lg font-serif font-bold text-amber-900">Prestige Auction</h2>
              <p className="text-[10px] text-amber-600 -mt-1">EST. 2024</p>
            </div>
          </div>
