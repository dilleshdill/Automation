...
const AdminAuctionNotStart = () => {
  return (
    ...
    <p class="text-sm md:text-base mx-auto max-w-2xl text-center mt-6 max-md:px-2">An auction is a process where items are sold to the person who offers the highest price.
