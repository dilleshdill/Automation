...
const AdminProfile = () => {
  ...
  const stats = [
    ...
    { label: "Auctions", value: "12", icon: "🎯" },
    { label: "Teams", value: "8", icon: "👥" },
    { label: "Players", value: "104", icon: "🏃" }
  ];
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { label: "Full Name", name: "adminName", value: adminData.adminName, icon: "👤" },
                    { label: "Email Address", name: "email", value: adminData.email, icon: "✉️" },
                    { label: "Phone Number", name: "phone", value: adminData.phone, icon: "📱" },
                    { label: "Role", name: "role", value: "Administrator", icon: "👑" }
                  ].map((field, index) => (
                    <div key={index}>
              ...
              {/* Supporters Section - Replacing Community */}
              <div className="pt-6 border-t border-slate-200">
                <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                  <span className="w-1 h-5 bg-slate-500 rounded-full"></span>
                  Support Our Franchise
                </h3>
                ...
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-200">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-slate-800">Support Our Franchise to Win!</p>
                        <p className="text-xs text-slate-600">Join 1,200+ active supporters</p>
                      </div>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                          <div>
                            <p className="text-sm font-semibold text-slate-800">
                              {i === 1 ? 'Auction Created' : i === 2 ? 'Team Updated' : 'Player Added'}
                            </p>
                            <p className="text-xs text-slate-600 mt-0.5">
                              {i === 1 ? 'IPL 2024 Mega Auction' : i === 2 ? 'Mumbai Indians squad' : 'Virat Kohli - ₹15Cr'}
                            </p>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="text-xs text-slate-500">{i*2}h ago</span>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { icon: "👥", label: "Permissions", desc: "Manage admin permissions" },
                  { icon: "🌐", label: "Security", desc: "Two-factor authentication" }
                ].map((item, index) => (
                  <button
                    key={index}
                  ...
                  <button className="w-full flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-xl hover:bg-red-100 transition-all group">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs text-red-600">Permanently delete admin account</p>
                      </div>
                    </div>
