...
const UserProfile = () => {
  ...
  const stats = [
    ...
    { label: "Auctions", value: "24", icon: "🎯" },
    { label: "Bids", value: "156", icon: "💰" },
    { label: "Won", value: "12", icon: "🏆" }
  ];
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    { label: "Full Name", name: "userName", value: userData.userName, icon: "👤" },
                    { label: "Email Address", name: "email", value: userData.email, icon: "✉️" },
                    { label: "Phone Number", name: "phone", value: userData.phone, icon: "📱" },
                    { label: "Location", name: "location", value: userData.location, icon: "📍" }
                  ].map((field, index) => (
                    <div key={index}>
                      ...
                      <div className="flex -space-x-2">
                        {[1,2,3,4].map((i) => (
                          <img
                            ...
                            src={`https://images.unsplash.com/photo-${i === 1 ? '1633332755192-727a05c4013d' : i === 2 ? '1535713875002-d1d0cf377fde' : i === 3 ? '1438761681033-6461ffad8d80' : '1472099645785-5658abf4ff4e'}?w=100&h=100&fit=crop`}
                            alt="community member"
                          />
                        ))}
                      </div>
                      <div>
                        <p className="text-sm font-semibold text-slate-800">Join 2,847 active bidders</p>
                        <p className="text-xs text-slate-600">Connect with auction enthusiasts</p>
                      </div>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                          <div>
                            ...
                            <p className="text-xs text-slate-600 mt-0.5">
                              Lot #2024-{i}56 • Current bid: $2,500
                            </p>
                          </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { icon: "💳", label: "Payments", desc: "Payment methods and billing" },
                  { icon: "🌐", label: "Privacy", desc: "Privacy and security settings" }
                ].map((item, index) => (
                  <button
                    key={index}
