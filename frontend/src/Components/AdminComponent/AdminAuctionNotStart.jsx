  ...
  return (
    <>
      ...
      <h5 class="text-4xl md:text-7xl font-medium max-w-[850px] text-center mx-auto mt-8">
        You Can Create New Auction Here
      </h5>

      <p class="text-sm md:text-base mx-auto max-w-2xl text-center mt-6 max-md:px-2">
        An auction is a process where items are sold to the person who offers
        the highest price. The final price is decided based on competition among
        participants within a limited time.
      </p>
